...
<head>
    ...
    <title>Sidad API Documentation</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-auth-login">Login and get access token.</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-profile">Get authenticated user profile.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-profile-password">
                                <a href="#endpoints-PUTapi-profile-password">Change password.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-customers">
                                <a href="#endpoints-GETapi-customers">List customers with search, filter, pagination.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-customers">
                                <a href="#endpoints-POSTapi-customers">Create new customer.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-customers--id-">
                                <a href="#endpoints-GETapi-customers--id-">Get single customer.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-customers--id-">
                                <a href="#endpoints-PUTapi-customers--id-">Update customer.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-customers--id-">
                                <a href="#endpoints-DELETEapi-customers--id-">Delete customer (soft delete).</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>merchant</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>merchant</code></li> <li><code>customer</code></li></ul>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-auth-login">Login and get access token.</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>qkunze@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-profile">Get authenticated user profile.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-profile-password">Change password.</h2>

<p>
</p>

<p>PUT /api/profile/password</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="new_password"                data-endpoint="PUTapi-profile-password"
...
<p>Must be at least 8 characters. Example: <code>mqeopfuudtdsufvyvddqamniihfqcoynlazghdtqtqxbajwbpilpmufinllwloauydlsmsjuryv</code></p>
                    ...
                    <h2 id="endpoints-GETapi-customers">List customers with search, filter, pagination.</h2>

<p>
</p>

<p>GET /api/customers?search=ahmad&amp;is_active=true&amp;sort_by=full_name&amp;sort_dir=asc&amp;per_page=20</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-customers">Create new customer.</h2>
...
<div class="bash-example">
    ...
    \"phone\": \"amniihfqcoynlazgh\",
    \"email\": \"roob.mona@example.org\",
    \"national_id\": \"xbajwbpilpmufinll\",
    \"address\": \"wloauydlsmsjuryvojcyb\",
    \"notes\": \"zvrbyickznkygloigmkwx\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 1000 characters. Example: <code>wloauydlsmsjuryvojcyb</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 2000 characters. Example: <code>zvrbyickznkygloigmkwx</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-customers--id-">Get single customer.</h2>
...
<p>The ID of the customer. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-customers--id-">Update customer.</h2>

<p>
</p>

<p>PUT /api/customers/{id}</p>
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-customers--id-">Delete customer (soft delete).</h2>

<p>
</p>

<p>DELETE /api/customers/{id}</p>
